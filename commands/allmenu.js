...
async function allMenu(sock, from, msg, session, commands) {
    ...
    const categories = {
        ...
        '💰 ECONOMY': ['wallet', 'daily', 'lb', 'addcoins'],
        ...
        '🎉 FUN': ['joke', 'meme', 'dare', 'truth', 'ascii', 'roast', 'compliment', 'ship', 'emojimix', 'character', 'quote', 'fact', 'trivia', 'coinflip', 'roll', 'riddle', 'wouldyourather', 'report', 'spam (50c)', 'smsbomb (50c)', 'callbomb (50c)', 'crash (50c)', 'freeze (50c)', 'lag (50c)', 'bug (50c)', 'nuke (50c)', 'hack (50c)', 'locspam', 'vcardspam', 'buttonspam', 'pollspam', 'contactspam', 'flirt', 'insult', 'pickup', 'dare', 'truth', 'tictactoe', '8ball', 'chess', 'hangman'],
